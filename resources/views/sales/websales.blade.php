            ...
            <div class="card" id="lobicard-custom-control" data-sortable="true">
                <div class="card-header">
                    <div class="card-title custom_title">
                        <h4>Web Sales Details
                            <a class="btn btn-add pull-right" href="{{ route('websalesform') }}"><i class="fa fa-file-text"></i>&nbsp; Add Web Sales</a>
                        </h4>
                    </div>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      getRenderedView('{!! route('websales') !!}');
