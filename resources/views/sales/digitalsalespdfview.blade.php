...
<div class="web_size">
    ...
    <div class="container">
        ...
        <div class="crm_client_form">
            <div class="ccf_left">
                <div class="ccf_tab">
                    ...
                    @php
                    $fullname = str_split( strtoupper($digitalsales->client_name) );
                    $surname = str_split( strtoupper($digitalsales->client_surname) );
                    $licounttotal1 = 24;
                    // $licountfullname = 11;
                    // $licountsurname = 10;
                    $tmpcount = 1;
                ...
                <div class="ccf_tab">
                    ...
                    @php
                    $compname = str_split( strtoupper($digitalsales->client_company_name) );
                    $licounttotal2 = 25;
                    $tmpcount = 1;
                    @endphp
                    <div class="ccf_tab_input">
                ...
                <div class="ccf_tab">
                    ...
                    @php
                    $addr = str_split( strtoupper($digitalsales->client_address_line_1) );
                    $suburb = str_split( strtoupper($digitalsales->client_suburb) );
                    $licounttotal3 = 24;
                    $tmpcount = 1;
                    @endphp
                    <div class="ccf_tab_input">
                ...
                <div class="ccf_tab">
                    ...
                    @php
                    $state = str_split( strtoupper($digitalsales->client_state) );
                    $postcode = str_split( strtoupper($digitalsales->client_postcode) );
                    $licounttotal4 = 3;
                    $licounttotal5 = 4;
                    $tmpcount = 1;
                    @endphp
                    <div class="ccf_tab_input">
                        ...
                        <div class="ccf_tab_part_space"></div>
                        @php
                        $abn = str_split( strtoupper($digitalsales->client_abn) );
                        $licounttotal6 = 11;
                        $tmpcount = 1;
                        @endphp
                ...
                <div class="ccf_tab">
                    ...
                    @php
                    $c_work = str_split( strtoupper($digitalsales->client_contact_work) );
                    $c_mobile = str_split( strtoupper($digitalsales->client_contact_mobile) );
                    $licounttotal7 = 10;
                    $licounttotal8 = 10;
                    $tmpcount = 1;
                    @endphp
                ...
                <div class="ccf_tab">
                    ...
                    @php
                    $_email = str_split( strtoupper($digitalsales->client_email) );
                    $licounttotal9 = 25;
                    $tmpcount = 1;
                    @endphp
                    <div class="ccf_tab_input">
                ...
                <div class="ccf_tab">
                    ...
                    @php
                    $_website = str_split( strtoupper($digitalsales->client_website) );
                    $licounttotal10 = 25;
                    $tmpcount = 1;
                    @endphp
                    <div class="ccf_tab_input">
            ...
            <div class="ccf_right">
                <div class="ccf_project_start">
                    ...
                    <span> {{ $digitalsales->project_start_date }} </span>
                </div>
                <div class="ccf_total">
                    <label><span>Total Amount</span></label>
                    <span class="dolar">{{ $digitalsales->project_amount }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="crm_client_form">
            <div class="ccf_full">
                <div class="ccf_check">
                    @if( in_array(1, $digitalsales->project_services) )
                ...
                <div class="ccf_check">
                    @if( in_array(2, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
                ...
                <div class="ccf_check">
                    @if( in_array(3, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
                ...
                <div class="ccf_check">
                    @if( in_array(4, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
                ...
                <div class="ccf_check">
                    @if( in_array(5, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
                ...
                <div class="ccf_check">
                    @if( in_array(6, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
                ...
                <div class="ccf_check">
                    @if( in_array(7, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
                ...
                <div class="ccf_check">
                    @if( in_array(8, $digitalsales->project_services) )
                    <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                    @else
                    <img src="{{ asset('images/check_box.png') }}" alt=""/>
                    @endif
        ...
        <div class="crm_item_table">
            <table>
                ...
                <tbody>
                    @foreach( $digitalsales->digitalSalesItems as $k => $item )
                    <tr class="{{ ($k % 2 ? 'sec' : '') }}">
                    ...
                    <tr class="sec">
                        ...
                        <td>
                            <div class="crm_total">
                                <label>{{ $digitalsales->sub_total }}</label>
                            </div>
                            <div class="crm_total">
                                <label>{{ $digitalsales->gst_total }}</label>
                            </div>
                            <div class="crm_total">
                                <label><span>{{ $digitalsales->total_amt }}</span></label>
                            </div>
                        </td>
                    </tr>
                </tbody>
            ...
            <div class="ccf_half">
                <div class="ccf_payment pay_one">
                    ...
                    <div class="ccf_check_full">
                        @if( $digitalsales->payment_method == 1 )
                        <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                        @else
                        <img src="{{ asset('images/check_box.png') }}" alt=""/>
                        @endif
                    ...
                    <div class="ccf_check_full">
                        @if( $digitalsales->payment_method == 2 )
                        <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                        @else
                        <img src="{{ asset('images/check_box.png') }}" alt=""/>
                        @endif
                ...
                <div class="ccf_payment pay_two">
                    ...
                    <div class="ccf_half">
                        <div class="ccf_check_full">
                            @if( $digitalsales->payment_type == 3 )
                            <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                            @else
                            <img src="{{ asset('images/check_box.png') }}" alt=""/>
                            @endif
                        ...
                        <div class="ccf_check_full">
                            @if( $digitalsales->payment_type == 1 )
                            <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                            @else
                            <img src="{{ asset('images/check_box.png') }}" alt=""/>
                            @endif
                    ...
                    <div class="ccf_half">
                        <div class="ccf_check_full">
                            @if( $digitalsales->payment_method == 3 )
                            <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                            @else
                            <img src="{{ asset('images/check_box.png') }}" alt=""/>
                            @endif
                        ...
                        <div class="ccf_check_full">
                            @if( $digitalsales->payment_type == 2 )
                            <img src="{{ asset('images/check_box_check.png') }}" alt=""/>
                            @else
                            <img src="{{ asset('images/check_box.png') }}" alt=""/>
                            @endif
            ...
            <div class="ccf_half">
                <div class="ccf_payment pay_three">
                    ...
                    <div class="ccf_tab_client">
                        ...
                        @php
                        $sales_personName = str_split( strtoupper($digitalsales->salesPerson->name) );
                        $tmpcount = 1;
                        @endphp
                        <div class="ccf_tab_client_input">
                            <ul>
                    ...
                    <div class="ccf_tab_date">
                        <label>Date</label>
                        <label>{{ get_date_server($digitalsales->authorisation_date) }}</label>
                    </div>
                    <div class="ccf_tab_signature">
                        <label>Signature</label>
                        <img src="{{ $digitalsales->authorisation_signature }}">
                    </div>
                </div>
            </div>
        </div>
