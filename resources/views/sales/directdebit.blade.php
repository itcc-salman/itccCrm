@extends('layouts.app')
@section('title','Direct Debit Sales')
...
<section class="content-header">
   ...
   <div class="header-title">
      <h1>Direct Debit</h1>
      <small>List of Direct Debit Sales</small>
   </div>
</section>
<!-- Main content -->
            ...
            <div class="card" id="lobicard-custom-control" data-sortable="true">
                <div class="card-header">
                    <div class="card-title custom_title">
                        <h4>Direct Debit Sales Details
                            <a class="btn btn-add pull-right" href="{{ route('directdebitform') }}"><i class="fa fa-file-text"></i>&nbsp; Add Direct Debit Sales</a>
                        </h4>
                    </div>
                </div>
                <div class="card-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      getRenderedView('{!! route('directdebit') !!}');
